...
public class BlockRegistry {
  ...
  public static final RegistryObject<Block> LIGHT_CAMO = BLOCKS.register("light_camo", () -> new BlockLightFacade(Block.Properties.create(Material.IRON)));
  ...
  public static void onBlocksRegistry(final RegistryEvent.Register<Block> event) {
    ...
    //
    r.register(new SoundmufflerBlockFacade(Block.Properties.create(Material.ROCK)).setRegistryName("soundproofing_ghost"));
