    ...
    public static class ToolMats {
        ...
        public static final Tier CREATIVE = TierSortingRegistry.registerTier(
                ...
                new ForgeTier(
                        ...
                        Tiers.NETHERITE.getUses() * 999,
                        Tiers.NETHERITE.getSpeed() * 999, // uses aka durability
                        Tiers.NETHERITE.getAttackDamageBonus() * 9999,  //Attack damage bonus
                        Tiers.NETHERITE.getEnchantmentValue() + 1,

                        BlockTags.create(new ResourceLocation(ModCyclic.MODID, "needs_obsidian_tool")), //Tag

                        () -> Ingredient.of(ItemRegistry.GEM_OBSIDIAN.get())),//Repair ingredient

                new ResourceLocation(ModCyclic.MODID, "creative"),
                List.of(Tiers.NETHERITE), List.of());
