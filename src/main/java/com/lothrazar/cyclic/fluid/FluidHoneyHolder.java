...
public class FluidHoneyHolder {
    ...
    private static final ResourceLocation FLUID_FLOWING = new ResourceLocation("cyclic:block/liquid/honey_flow");
    private static final ResourceLocation FLUID_STILL = new ResourceLocation("cyclic:block/liquid/honey_still");//"minecraft:block/" + id + "_block_top"
